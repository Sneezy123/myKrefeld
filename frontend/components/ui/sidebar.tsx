...
interface SidebarProps extends React.HTMLAttributes<HTMLDivElement> {
    ...
    collapsible?: 'oncanvas' | 'offcanvas' | 'icon' | 'none';
}
    ...
    if (collapsible === 'none') {
        return (
            <div
                data-slot='sidebar'
                className={cn(
                    'bg-sidebar text-sidebar-foreground flex h-full w-[var(--sidebar-width)] flex-col font-sans',
                    className
                )}
                {...props}
            >
...
function SidebarGroupAction({ className, asChild = false, showOnHover = false, ...props }: SidebarGroupActionProps) {
