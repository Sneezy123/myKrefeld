...
const dbUri = 'mongodb+srv://nilshendrik13:67L87QWjzjnhPNYu@mykrefeldcluster.ftrmtih.mongodb.net/?retryWrites=true&w=majority&appName=myKrefeldCluster';
...
const updateEvents = async () => {
    try {
        ...
        for (var i = 0; i < total_pages; i++) {
            ...
            const response = await axios.get(`https://veranstaltung.krefeld651.de/wp-json/tribe/events/v1/events?page=${i+1}&per_page=100&start_date=${today}`);
